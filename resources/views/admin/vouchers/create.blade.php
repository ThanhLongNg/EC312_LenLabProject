    ...
    <div class="bg-surface-light dark:bg-surface-dark rounded-xl shadow-card border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Tạo mã giảm giá mới</h2>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tạo mã giảm giá để thu hút khách hàng</p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-bold text-gray-900 dark:text-white" id="preview-code">VOUCHER_CODE</div>

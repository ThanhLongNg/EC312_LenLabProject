    ...
    <div class="w-full max-w-md">
        ...
        <div class="auth-container rounded-2xl p-8 shadow-2xl">
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-white mb-2">Chào mừng bạn trở lại!</h1>
                <p class="text-gray-400 text-sm">Thế giới len thủ công đang chờ bạn.</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="text-center text-gray-400 text-sm">
                    Chưa có tài khoản? 
                    <a href="{{ route('register') }}" class="text-primary hover:text-primary/80 transition-colors font-medium">
                        Đăng ký ngay
                    </a>
                </div>
            </form>
